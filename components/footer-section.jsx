          ...
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li>
                  <a href="#home" onClick={(e) => scrollToSection(e, "home")} className="hover:text-amber-400">
                    Home
                  </a>
                </li>
                <li>
                  <a href="#rooms" onClick={(e) => scrollToSection(e, "rooms")} className="hover:text-amber-400">
                    Rooms & Suites
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#gallery" onClick={(e) => scrollToSection(e, "gallery")} className="hover:text-amber-400">
                    Gallery
                  </a>
                </li>
                <li>
                  <a href="#contact" onClick={(e) => scrollToSection(e, "contact")} className="hover:text-amber-400">
                    Contact
                  </a>
                </li>
              </ul>
